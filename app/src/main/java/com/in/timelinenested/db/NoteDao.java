...
public class NoteDao {
    ...
    public List<Note> queryNotesAll(int groupId) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                note.setRecordTime(cursor.getString(cursor.getColumnIndex("n_create_time")));
    ...
    public long insertNote(Note note) {
        ...
        try {
            ...
            stat.bindString(8, note.getRecordTime());
    ...
    public void updateNote(Note note) {
        ...
        values.put("n_create_time", note.getRecordTime());
